...
config_file = os.path.join(ws_dir, "src/ros2-performance/irobot_benchmark/config/topologies", config_file)
out_file = os.path.join(ws_dir, "src/ros2-performance/irobot_benchmark/topology", out_file)
